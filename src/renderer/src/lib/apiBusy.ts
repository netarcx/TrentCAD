...
const FRIENDLY_LABELS: Record<string, string> = {
  ...
  syncCoordinationRepo: 'Syncing team repo',
  setupCoordinationRepo: 'Connecting to team',
  previewCoordinationRepo: 'Loading team info',
  createCoordinationRepo: 'Creating team repo',
  requestToJoinTeam: 'Sending join request',
  approveJoinRequest: 'Approving member',
